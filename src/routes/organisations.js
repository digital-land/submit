...
router.get('/:lpa/:dataset/:resource/:issue_type/:issue_field/:pageNumber', OrganisationsController.getIssueDetailsMiddleware)
router.get('/:lpa/:dataset/:resource/:issue_type/:issue_field', OrganisationsController.getIssueDetailsMiddleware)
