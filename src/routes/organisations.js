...
router.get('/:lpa/:dataset/data/:pageNumber', OrganisationsController.getDatasetDataviewMiddleware)
router.get('/:lpa/:dataset/data', OrganisationsController.getDatasetDataviewMiddleware)
router.get('/:lpa/:dataset/:issue_type/:issue_field/entry/:pageNumber', OrganisationsController.getIssueDetailsMiddleware)
router.get('/:lpa/:dataset/:issue_type/:issue_field/entry', OrganisationsController.getIssueDetailsMiddleware)
